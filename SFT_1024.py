...
def init_model(lm_config):
    tokenizer = AutoTokenizer.from_pretrained('Kokomi_tokenizer')
    model = Kokomi(lm_config)
    ckp = f'./results/SFT.pth'
...
if __name__ == "__main__":
     ...
     parser.add_argument("--wandb_project", type=str, default="Kokomib-SFT")
     ...
     args.wandb_run_name = f"Kokomi-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
